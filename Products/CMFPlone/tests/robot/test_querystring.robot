...
Scenario: Location query Current
    ...
    When I open the operator Current in the criteria Location
...
Scenario: Location query Parent
    ...
    and a bunch of folders
    and the querystring pattern
    When I open the operator Parent in the criteria Location
...
Scenario: Location query Custom
    ...
    and a bunch of folders
    and the querystring pattern
    When I open the operator Custom in the criteria Location
...
Scenario: Location query Advanced
    ...
    and a bunch of folders
    and the querystring pattern
    When I open the operator Advanced in the criteria Location
...
Scenario: Location query Simple
    ...
    and a bunch of folders
    and the querystring pattern
    When I open the operator Simple in the criteria Location
...
Scenario: Tag query one
    ...
    and a bunch of folders
    and the querystring pattern
    When I open the operator Matches any of in the criteria Tag
...
Scenario Tag query two
    ...
    and a bunch of folders
    and the querystring pattern
    When I open the operator Matches all of in the criteria Tag
    and I open the Selection Widget
    and Wait Until Element Is Visible  css=li.select2-results-dept-0.select2-result.select2-result-selectable.select2-option-o
    and Click Element  css=li.select2-results-dept-0.select2-result.select2-result-selectable.select2-option-o
    Then we expect 4 hits
...
Scenario Event end date query
    ...
    and the querystring pattern
    #Bevore date
    When I open the operator Before date in the criteria Event end date
    ...
    # Then we expect 2 hits
    #Between dates
    When I open the operator Between dates in the criteria Event end date
...
Scenario Creator query
    ...
    and a bunch of folders
    and the querystring pattern
    When I open the operator currentuser in the criteria Creator
